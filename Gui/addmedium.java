 ...
 * @author MSI
 */
public class addmedium extends javax.swing.JFrame {
    ...
    public addmedium(addclass ac) {
      ...
      public addmedium(addsubject as) {
        initComponents();
        loadmedium();
        this.as = as;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Subject Medium");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (m.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please Enter a Medium Name", "warning", JOptionPane.WARNING_MESSAGE);
        } else {

            try {

                ResultSet rs = MySQL.search("SELECT * FROM `medium` WHERE `name`='" + m + "' ");

                if (rs.next()) {
                    JOptionPane.showMessageDialog(this, "This Medium is already added!", "warning", JOptionPane.WARNING_MESSAGE);
                    jTextField1.setText("");
                } else {

                    MySQL.iud("INSERT INTO `medium`(`name`) VALUES('" + m + "') ;");
                    ...
                    JOptionPane.showMessageDialog(this, "Medium Added!", "Success", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addmedium.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
