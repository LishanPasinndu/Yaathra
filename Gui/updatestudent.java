...
public class updatestudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Student Detailes");
        ...
        jLabel11.setText(" Double Click on table to Select Student And Update Student Detailes");
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jComboBox1, jDateChooser1, jLabel5, jTextField3, jTextField4, jTextField5});
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sno", "Fname", "Lname", "DOB", "Contact", "Line 1", "Line 2", "City"
            }
        ) {
        ...
        jLabel10.setText("Select Student For Update");
        ...
        if (up == -1) {
            ...
            if (fname.isEmpty()) {
                ...
                try {
                    ...
                    MySQL.iud("UPDATE `student` SET `fname`='" + fname + "',`lname`='" + lname + "',`dob`='" + ndob + "',`contact`='" + contact + "',`line1`='" + line1 + "',`line2`='" + line2 + "',`city_id`='" + city_id + "' WHERE `Sno`='" + Sno + "' ");

                    loadstudent();
                    resetfield();
                    JOptionPane.showMessageDialog(this, "Student Update Successfull", "Success!", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (up == -1) {
                ...
                String sno = jTable1.getValueAt(up, 0).toString();
                String fname = jTable1.getValueAt(up, 1).toString();
                String lname = jTable1.getValueAt(up, 2).toString();
                //String dob = jTable1.getValueAt(up, 3).toString();
                String contact = jTable1.getValueAt(up, 4).toString();
                String line1 = jTable1.getValueAt(up, 5).toString();
                String line2 = jTable1.getValueAt(up, 6).toString();
                String city = jTable1.getValueAt(up, 7).toString();
