...
public class viewclass extends javax.swing.JFrame {
    ...
    public viewclass(viewatendence vaa) {
        initComponents();
        loadClass();
        this.vaa = vaa;
    ...
    public void searchClass() {
        ...
        try {
            ...
            String class_no = jTextField1.getText();
            String teacher = jTextField2.getText();
            String subject = jTextField3.getText();
            String medium = jTextField4.getText();
            ...
            if (class_no.isEmpty()) {
                ...
                queryVector.add("`class`.`ClassNo`= '" + class_no + "'  ");
            }
            //class_no
            ...
            if (teacher.isEmpty()) {
                ...
                queryVector.add("`teacher`.`fname` LIKE '%" + teacher + "%'  ");
            }
            //teacher
            ...
            if (subject.isEmpty()) {
                ...
                queryVector.add("`subject`.`name` LIKE '%" + subject + "%'  ");
            }
            //subject
            ...
            if (medium.isEmpty()) {
                ...
                queryVector.add("`medium`.`name` LIKE '%" + medium + "%'  ");
            }
            //subject
            ...
            ResultSet rs = MySQL.search("SELECT * FROM `class` INNER JOIN `teacher` ON `teacher`.`Tno`=`class`.`teacher_Tno` INNER JOIN `subject` ON `subject`.`subNo`=`class`.`subject_subNo` INNER JOIN `medium` ON `medium`.`id`=`class`.`medium_id`" + wherequery + " ; ");
    ...
    private void initComponents() {
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel2, jLabel4, jLabel5, jLabel6, jTextField1, jTextField2, jTextField3, jTextField4});

        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jButton5, jLabel7, jTextField5});
    ...
    private void jTextField1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyTyped
        ...
        String text = classno + evt.getKeyChar();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (r == -1) {
                ...
                String time = jTable1.getValueAt(r, 1).toString();
                String subject = jTable1.getValueAt(r, 3).toString();
                String teacher = jTable1.getValueAt(r, 6).toString();
                String fee = jTable1.getValueAt(r, 7).toString();
                String grade = jTable1.getValueAt(r, 4).toString();

                if (vaa != null) {

                    vaa.jLabel20.setText(classno);
                    vaa.jLabel21.setText(teacher);
                    vaa.jLabel22.setText(time);
                    vaa.jLabel23.setText(subject);
                    vaa.jButton1.setEnabled(false);

                    try {
                        ResultSet rs = MySQL.search("SELECT * FROM `attendence` INNER JOIN `student` ON `student`.`Sno`=`attendence`.`stu_no` INNER JOIN `class` ON `class`.`ClassNo`=`attendence`.`class_no` INNER JOIN `subject` ON `subject`.`subNo`=`class`.`subject_subNo` INNER JOIN `teacher` ON `teacher`.`Tno`=`class`.`teacher_Tno` WHERE `class`.`status`='1' AND `class`.`ClassNo`='" + classno + "' ORDER BY `attendence`.`date` ASC ");

                        DefaultTableModel dtm = (DefaultTableModel) vaa.jTable1.getModel();
                        dtm.setRowCount(0);
                ...
                if (pas != null) {
                    ...
                    pas.cla.setText(classno);
                    pas.tea.setText(teacher);
                    pas.gra.setText(grade);
                    pas.sub.setText(subject);
                    pas.fe.setText(fee);

                    pas.jButton8.setEnabled(false);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (del == -1) {
            ...
            String classno = jTable1.getValueAt(del, 0).toString();

            MySQL.iud("UPDATE `class` SET `class`.`status`='2' WHERE `class`.`ClassNo`='" + classno + "'; ");

            loadClass();
            JOptionPane.showMessageDialog(this, "Class Delete Successfull", "Deleted!", JOptionPane.INFORMATION_MESSAGE);
        }
